...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
   ...
   const updateAccess = useCheckPermissions(['vehicle-type:update']);
   const deleteAccess = useCheckPermissions(['vehicle-type:delete']);
         ...
         <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end">
               ...
               <DropdownMenuItem
                  ...
                  onClick={() =>
                     router.push(`/dashboard/vehicle-type/read?id=${data.id}`)
                  }
               >
               ...
               {updateAccess && (
                  <DropdownMenuItem
                     ...
                     onClick={() =>
                        router.push(
                           `/dashboard/vehicle-type/update?id=${data.id}`
                        )
                     }
                  >
